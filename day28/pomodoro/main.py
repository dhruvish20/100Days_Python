...
title_label = Label(text="Timer" , fg= GREEN , font=(FONT_NAME , 50 , "normal") , background= YELLOW)
title_label.grid(row= 0, column= 1)

file_path = os.path.join(os.path.dirname(__file__) , "tomato.png")
image_file = PhotoImage(file= file_path)
